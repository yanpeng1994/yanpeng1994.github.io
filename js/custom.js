...
$(document).ready(function() {
    function e() {
        $(".header-1").length > 0 && ($(window).width() < 1500 ? $("header").find(".noo-menu-option").find("li").length > 0 && $("header").find(".noo-menu-option").addClass("collapse") : $("header").find(".noo-menu-option").removeClass("collapse")),
        $(".header-3").length > 0 && ($(window).width() < 1300 ? $("header").find(".noo-menu-option").find("li").length > 0 && $("header").find(".noo-menu-option").addClass("collapse") : $("header").find(".noo-menu-option").removeClass("collapse"))
    }
    function o(e) {
        var o = this.currentItem;
        $(".noo-testimonial-sync1").find(".owl-item").removeClass("synced").eq(o).addClass("synced"),
    ...
    if ($(".noo-search").on("click",
    function() {
        return $(".search-header5").fadeIn(1).addClass("search-header-eff"),
    ...
    }), $(".button-menu-extend").on("click",
    function() {
        return $(".noo-menu-extend-overlay").fadeIn(1,
        function() {
            $(".noo-menu-extend").addClass("show")
        }).addClass("show"),
        !1
    }), $(".menu-closed, .noo-menu-extend-overlay").on("click",
    function() {
        ...
        e()
    }), $("#off-canvas-nav li.menu-item-has-children").append('<i class="fa fa-angle-down"></i>'), $("#off-canvas-nav li.menu-item-has-children i").on("click",
    function(e) {
        var o = $(this);
        o.prev().slideToggle(300),
        o.parent().toggleClass("active")
    }), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && $(".navbar-nav").find(".menu-item-has-children").find("a").on("touchstart",
    function(e) {
        "use strict";
        var o = $(this);
    ...
    $(".noo-testimonial-sync1").on("click", ".owl-item",
    function(e) {
        e.preventDefault();
    ...
    $(".box-inner").each(function() {
        ...
        $(this).find(".product-box-header li:first-child span").css("background", e).addClass("acitve"),
